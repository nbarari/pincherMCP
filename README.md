...
| **v0.72** | **Multi-branch PK widening + Java/Rust AST + TS receiver-type resolver.** [#1303](https://github.com/kwad77/pincher/issues/1303) Phase 2b — v28-style table rebuild widening `symbols`/`edges`/`files` PKs to include `branch` for true multi-branch coexistence ([#1371](https://github.com/kwad77/pincher/issues/1371)). Java + Rust AST extractors via tree-sitter or pure-Go equivalent ([#1182](https://github.com/kwad77/pincher/issues/1182) / [#1183](https://github.com/kwad77/pincher/issues/1183)). TS receiver-type resolver ([#1177](https://github.com/kwad77/pincher/issues/1177)). | 🚧 in flight |
