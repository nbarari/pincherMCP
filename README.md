...
| **v0.83** | **Polish + dogfood reserve.** Per `.planning-roadmap-to-v1.md` cadence — composite suite already complete, this minor drains umbrella follow-ups + dogfood-found patches that surface in the v0.82 soak window. | 🚧 in flight |
