...
| **v0.13.0** | JS AST extractor (replaces regex for `*.js`/`*.jsx`, behind `PINCHER_EXPERIMENTAL_JS_AST=1`, [#266](https://github.com/kwad77/pincher/issues/266)) + supervisor flake hardening ([#383](https://github.com/kwad77/pincher/issues/383)). | 🚧 in flight |
