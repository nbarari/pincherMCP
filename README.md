...
| **v0.67** | **Dashboard panel rendering + AST extractor sweep.** Carry-forward: dashboard substrate from v0.64 ([#635](https://github.com/kwad77/pincher/issues/635)), TS receiver-type resolver ([#1177](https://github.com/kwad77/pincher/issues/1177)), Rust + Java AST extractors ([#1182](https://github.com/kwad77/pincher/issues/1182) / [#1183](https://github.com/kwad77/pincher/issues/1183)), closure-tables-default-on gated on the #639 10k-file measurement ([#1162](https://github.com/kwad77/pincher/issues/1162)), OTLP + Prometheus observability standardization ([#1163](https://github.com/kwad77/pincher/issues/1163)), #1231 root-cause investigation now that the parity guard surfaces concrete data. | 🚧 in flight |
