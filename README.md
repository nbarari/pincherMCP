...
| **v0.14.0** | **Token-savings + performance focus.** Field projection across every read tool ([#400](https://github.com/kwad77/pincher/issues/400)); project-ID resolution cache + reader-pool warming ([#401](https://github.com/kwad77/pincher/issues/401)); adaptive trace depth ([#402](https://github.com/kwad77/pincher/issues/402)); design work on the bigger structural wins — closure tables, diff-encoded `context`, gzip transport ([#403](https://github.com/kwad77/pincher/issues/403)). | 🚧 in flight |
