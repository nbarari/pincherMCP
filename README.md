...
| **v0.76** | **MCP roots/list multi-root auto-discovery + Phase 3 docs catch-up.** Multi-root iteration + bloat-trap clearance per root + `_meta.auto_indexed` field surfacing ([#1081](https://github.com/kwad77/pincher/issues/1081)). | 🚧 in flight |
