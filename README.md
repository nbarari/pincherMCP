...
| **v0.25.0** | **Dashboard API hardening.** Pagination for `/v1/projects` ([#530](https://github.com/kwad77/pincher/issues/530)), `/v1/sessions` ([#531](https://github.com/kwad77/pincher/issues/531)), `/v1/search` ([#532](https://github.com/kwad77/pincher/issues/532)); index-progress ETA ([#535](https://github.com/kwad77/pincher/issues/535)); `dashboard_version` on `/v1/health` ([#536](https://github.com/kwad77/pincher/issues/536)); standardized error response shape ([#537](https://github.com/kwad77/pincher/issues/537)). Part of [#519](https://github.com/kwad77/pincher/issues/519). | 🚧 in flight |
