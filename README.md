...
| **v0.54.0** | **Closure tables + streamable-HTTP MCP transport.** First beta-tag release (`v0.54.0-beta.1`) exercising v0.53's release-channel infrastructure. Closure-table 10k-file measurement ([#639](https://github.com/kwad77/pincher/issues/639)) + closure-tables phase 1 implementation ([#652](https://github.com/kwad77/pincher/issues/652)) for transitively-reachable graph queries. Streamable-HTTP MCP transport ([#651](https://github.com/kwad77/pincher/issues/651)) — second wire format alongside stdio. | 🚧 in flight |
