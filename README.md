...
| **v0.84** | **API freeze checkpoint** ([ADR-0002](docs/adr/0002-v1-frozen-surface.md)). Every PR touching a frozen surface element after this minor either reverts or routes to 2.x. Schema-migration language-scoped selective invalidation ([#1543](https://github.com/kwad77/pincher/issues/1543)), MCP capability-surface expansion (notifications/progress for index/fetch/rebuild_fts; `guide` exposed as MCP Prompt — [#1080](https://github.com/kwad77/pincher/issues/1080) [#1082](https://github.com/kwad77/pincher/issues/1082)). | 🚧 in flight |
