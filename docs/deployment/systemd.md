...
curl -L -o pincher.tar.gz https://github.com/kwad77/pincher/releases/download/v0.88.0/pincher-v0.88.0-linux-amd64.tar.gz
tar -xzf pincher.tar.gz && sudo mv pincher-v0.88.0-linux-amd64 /usr/local/bin/pincher
