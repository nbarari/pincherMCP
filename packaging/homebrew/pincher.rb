...
#
# Pinned to v0.38.0. The SHA256 values below are from the authoritative
# SHA256SUMS file published with that release:
# https://github.com/kwad77/pincher/releases/download/v0.38.0/SHA256SUMS
#
# Usage:
...
class Pincher < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "3d497fd07396f411cddc567ced8a20d8e5969ad64f1248d23c087260e73976be"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-darwin-amd64.tar.gz"
      sha256 "57e08f10461bf8d363969a5d6bfdfbd7852e28873438c317c43495b2d938b423"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "6c1e9315e0a56246ef86636c0cda7e3266d81816bc6da08d87b3b7ccf034c301"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-linux-amd64.tar.gz"
      sha256 "a11d68c537722ba0461842149e5817c745a37c95fff0ba6e5666bc147eb94f7e"
    end
  end
