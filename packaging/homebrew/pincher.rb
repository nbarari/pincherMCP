...
#
# Pinned to v0.80.0. The SHA256 values below are from the authoritative
# SHA256SUMS file published with that release:
# https://github.com/kwad77/pincher/releases/download/v0.80.0/SHA256SUMS
#
# Usage:
...
class Pincher < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "a3c5f76d56469468c43c271f41d31ac04d832945378a69a7fb0d0f2f30d4d371"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-darwin-amd64.tar.gz"
      sha256 "215d779cc713168a4ba0e0964ff6e98be0eabd4d3c0b87e2ebea2529c9bfe54d"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "40c13cc403e6766336eceee07bd889125ca7c50f6a4b3274778c1abe20e55c3c"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-linux-amd64.tar.gz"
      sha256 "b2de755722e7af8750031f75dbb5040231adfdabef8d25ce0cb4890c322d7e37"
    end
  end
