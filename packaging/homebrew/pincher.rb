...
#
# Pinned to v0.50.0. The SHA256 values below are from the authoritative
# SHA256SUMS file published with that release:
# https://github.com/kwad77/pincher/releases/download/v0.50.0/SHA256SUMS
#
# Usage:
...
class Pincher < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "b911ff0590ccc8a8599c9bfedee5a1ea91657189f71550a34210db578d296b2e"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-darwin-amd64.tar.gz"
      sha256 "f6ce58390586ff9134a048f787839608d94b039d24f659bd84ed52f51ccc1d58"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "078e26f440933dcf47f5237d97cb696df790d2b26631a8c25274857fdede97c2"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-linux-amd64.tar.gz"
      sha256 "eb97fee069d5f6861bac9f6b67b37ec31fc31a891ef238999bc31cb99c45910f"
    end
  end
