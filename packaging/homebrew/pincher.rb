...
#
# Pinned to v0.51.0. The SHA256 values below are from the authoritative
# SHA256SUMS file published with that release:
# https://github.com/kwad77/pincher/releases/download/v0.51.0/SHA256SUMS
#
# Usage:
...
class Pincher < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "cdd4b58ce1daca1ea4768cff850a8ee19ee37fc0095cea0faec672f887906c6d"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-darwin-amd64.tar.gz"
      sha256 "5653f9de9fd25df0a389e68dfe4cfcf98dd7abe8be23a431e8f7da3b0960fcf7"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "652051ae1b83e50b6dd67c8f355e128e9ebc6670be677fa062658004c8d46e8f"
    end
    on_intel do
      url "https://github.com/kwad77/pincher/releases/download/v#{version}/pincher-v#{version}-linux-amd64.tar.gz"
      sha256 "981e19be72a103f6821d34945a25d2e6d4bc3cecfac9c66e2b8d30088e27934a"
    end
  end
